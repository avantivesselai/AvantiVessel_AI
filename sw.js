...
const CACHE = 'avanti-site-v1.4.0';
const TELAS = [
...
const CORE = [
  './', './index.html', './login.html', './support.js', './avanti-auth.js', './avanti-app.js', './avanti-theme.js', './avanti-brain.js', './avanti-clima.js', './avanti-voz.js', './base-conhecimento.json',
