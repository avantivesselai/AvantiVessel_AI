...
(function () {
  ...
  var ANSWERS = {
    ...
    horimetros: function (p) { return { text: 'Horímetros (25/09 13:40 · motores a 600 rpm):\n• motor BB 110,0 h\n• motor BE 106,0 h\n• gerador 285,6 h\nPróxima revisão dos motores: 16/01/2027 (D-117) ou 280 h — faltam 170,0 h; a data vence antes.', src: 'Fonte: telemetria NMEA · agenda preditiva · Health Check 47715565', actions: act(p, [['Manutenção', 'manut']]) }; },
